...
#ifndef TEST_INCLUDE_HOBOTXROC_C_DATA_TYPES_ARRAY_H_
#define TEST_INCLUDE_HOBOTXROC_C_DATA_TYPES_ARRAY_H_
...
#define XROC_CAPI_INHERIT_FROM_ARRAY(ChildType, size)                  \
  ...
  inline void HobotXRocCapi##ChildType##Free(                          \
      HobotXRocCapi##ChildType** data) {                               \
    free((*data)->values_);                                            \
...
#endif  // TEST_INCLUDE_HOBOTXROC_C_DATA_TYPES_ARRAY_H_
