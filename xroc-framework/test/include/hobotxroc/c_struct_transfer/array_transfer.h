...
#ifndef TEST_INCLUDE_HOBOTXROC_C_STRUCT_TRANSFER_ARRAY_TRANSFER_H_
#define TEST_INCLUDE_HOBOTXROC_C_STRUCT_TRANSFER_ARRAY_TRANSFER_H_
...
#define XROC_ARRAY_CHILD_TRANSFER(ChildType)                            \
  ...
  inline XROC_DEFINE_2CPP_TRANSFER_FUNC(ChildType, c) {                 \
    XROC_BASE_2CPP_TRANSFER_PROCESS(ChildType, c, cpp, c->values_size_, \
                                    c->values_);                        \
    auto& in = c;                                                       \
    auto& out = cpp;                                                    \
    out->class_ = in->class_;                                           \
...
#endif  // TEST_INCLUDE_HOBOTXROC_C_STRUCT_TRANSFER_ARRAY_TRANSFER_H_
